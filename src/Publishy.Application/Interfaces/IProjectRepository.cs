...
public interface IProjectRepository
{
    ...
    Task<IEnumerable<Project>> GetAllAsync(int page, int pageSize, ProjectStatus? status = null, DateTime? createdAfter = null, DateTime? createdBefore = null, CancellationToken cancellationToken = default);
    ...
    Task<int> GetTotalCountAsync(ProjectStatus? status = null, DateTime? createdAfter = null, DateTime? createdBefore = null, CancellationToken cancellationToken = default);
}